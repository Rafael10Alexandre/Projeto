...
class DaoVenda :
    ...
    def salvar (cls, venda: Venda):
        with open ('venda.txt', 'a') as arq:
            arq.writelines(venda.intensVendido.nome + 
                           '|' + venda.intensVendido.preco + 
                           '|' + venda.intensVendido.categoria +
                           '|' + venda.vendedor +
                           '|' + venda.comprador +
...
class DaoEstoque:
    ...
    def salvar (cls, produto: Produtos, quantidade):
        with open('estoque.txt ','a') as arq:
            arq.writelines(produto.name + "|" + produto.preco + "|" +
...
class DaoPessoa:
    ...
    def ler(cls):
        ...
        for i in cls.clientes:
            clientes.append(Pessoa(i[0], i[1], i[2], [3], i[4]))
...
class DaoFuncionario:
    ...
    def salvar(cls, funcionario: Funcionario):
        ...
        for i in cls.funcionario:
            funcionario.append(Pessoa(i[0], i[1], i[2], [3], i[4], i[5]))
